...
sub write_cleanup_script {
    ...
    # TJN: (4apr2018) Hacking for DVM
    if ($MTT::Globals::Values->{tjn_skip_orte_cleanup}) {

        print "NOTICE - AVOID WRITING OMPI CLEANUP SCRIPT\n";
        print "NOTICE - SKIP_ORTE_CLEANUP WAS ENABLED\n";
...
print "NOTICE - SKIP_ORTE_CLEANUP WAS ENABLED (DO NOTHING)\n";
exit(0);
';
